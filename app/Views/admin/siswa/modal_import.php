<div id="modal-import-siswa" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800" data-modal-hide="modal-import-siswa">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="<?= base_url('admin/import/siswa') ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div>
