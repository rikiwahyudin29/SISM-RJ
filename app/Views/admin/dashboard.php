...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
        ...
        <div class="p-4 bg-white dark:bg-[#1e293b] border dark:border-slate-700 rounded-2xl shadow-sm text-center relative overflow-hidden group">
    <svg class="absolute -right-2 -bottom-2 w-12 h-12 text-pink-500/10 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 20 20">
    ...
    <p class="text-[9px] font-[800] text-gray-400 dark:text-slate-500 uppercase tracking-widest mb-1 relative z-10">Wali Kelas</p>
    <h4 class="text-xl font-[800] text-pink-600 dark:text-pink-500 relative z-10"><?= number_format($total_walikelas ?? 0) ?></h4>
</div>
        <div class="p-4 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-2xl shadow-sm text-center relative overflow-hidden group">
