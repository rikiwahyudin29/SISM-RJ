...
<div class="container mx-auto px-4 py-6 max-w-lg">
    ...
    <?php if($sudah_absen): ?>
        <div class="bg-emerald-100 text-emerald-800 p-6 rounded-2xl text-center border border-emerald-200">
            ...
            <a href="<?= base_url('guru/presensi') ?>" class="inline-block mt-4 px-4 py-2 bg-emerald-600 text-white rounded-lg font-bold">Lihat Riwayat</a>
        </div>
    <?php else: ?>
        ...
        <form id="form-absen" action="<?= base_url('guru/presensi/submit_absen') ?>" method="POST">
            <?= csrf_field() ?>
...
<script>
    ...
    function errorPosisi(err) {
        document.getElementById('info-jarak').innerText = "GPS Error: " + err.message;
    }
