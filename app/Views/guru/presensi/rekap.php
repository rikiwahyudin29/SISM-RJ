...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    <div class="flex justify-between items-center mb-6">
        ...
        <form action="" method="get" class="flex gap-2">
            ...
            <a href="<?= base_url('guru/presensi/cetak_rekap?bulan='.$bulan) ?>" target="_blank" class="bg-rose-600 text-white px-4 py-2 rounded-xl font-bold text-sm flex items-center gap-2">
